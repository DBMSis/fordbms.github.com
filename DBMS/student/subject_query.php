...
<div style="width:770px;">
      <label class="label_title" style="width:100px; margin-left:170px;" >论文编号:</label>
...
<br>
<div style="width:770px;">
      <label class="label_title" style="width:100px; margin-left:170px;" >论文题目:</label>
...
if ($query) {
    ...
    if (empty($count)) {
        ...
        ?>
        <br>
        <table width="860" border="0" cellspacing="1" cellpadding="0" bgcolor="#000000" align="center" style="margin-left:250px;margin-top:10px;">
            <tr>
                <td>
                    <div class="text" align="center">论文编号</div>
                </td>
                <td>
                    <div class="text" align="center">论文题目</div>
                </td>
                <td>
                ...
                <td>
                    <div class="text" align="center">论文状态</div>
                </td>
            ...
            <tr>
                ...
                <td width="5%">
                    <div align="center" class="text" style="margin-top:10px;"><?php echo "" . $row_one['subject_ID'] . ""; ?></div>
                </td>
                <td width="20%">
                    <div align="center" class="text"><?php echo "" . $row_one['subject_title'] . ""; ?></div>
                </td>
                <td width="5%">
                    <div align="center" class="text"><?php echo "" . $row_one['teacher_ID'] . ""; ?></div>
                </td>
