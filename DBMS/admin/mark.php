...
include("admin_test.php");//检查老师是否登陆
?>
<!doctype html>
...
<?php
$sql = "select count(*) as num from $Subject where student_ID is not null and mark is null";
...
$sql = "select * from $Subject where student_ID is not null and mark is null order by student_ID asc limit $offset,$PAGE_NUM";
$query = mysqli_query($DB,$sql) or die("连接错误！~~~~~~~~~~~~~~");
