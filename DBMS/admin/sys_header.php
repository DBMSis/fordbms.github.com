...
<div class="body_wrap">
    <div class="container">
        ...
        <div class="content " role="main">
            ...
            <!-- row -->
            <div class="row">
                <div class="col-sm-8" style="padding-left: 110px;width: 565px;">
                    <h6 class="foo">Menu</h6>

                    <!-- Website Menu -->
                    <div class="dropdown-wrap boxed-velvet">
                        <ul class="dropdown inner clearfix" style="width: 760px;">
                            ...
                            <li class="menu-level-0"><a href="#"><span>信息添加</span></a>
                                <ul class="submenu-1">
                                    <li class="menu-level-1"><a href="teacher.php">教师信息</a></li>
                                    <li class="menu-level-1"><a href="student.php">学生信息</a></li>
                                    <li class="menu-level-1"><a href="subject_add.php">课题信息</a></li>
                                    <li class="menu-level-1"><a href="mark.php">成绩评定</a></li>  
                                </ul>
                            </li>
                            <li class="menu-level-0"><a href="#"><span>信息传递</span></a>
                                <ul class="submenu-1">
                                    <li class="menu-level-1"><a href="sendmail.php">信息发送</a></li>
                                    <li class="menu-level-1"><a href="accept.php">信息接收</a></li>
                                    <li class="menu-level-1"><a href="send.php">文件上传</a></li>                                  
                                </ul>
                            </li>
                            <li class="menu-level-0"><a href="comment.php"><span>留言板</span></a></li>
                            <li class="menu-level-0"><a href="admin_clear_cookie.php"><span>退出登录</span></a></li>
                        </ul>
                    </div>
                    <!--/ Website Menu -->
                </div>    
